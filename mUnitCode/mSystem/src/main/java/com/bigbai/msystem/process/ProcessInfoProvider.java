package com.bigbai.msystem.process;
...
/**
 * 获取当前正在运行的App
 * 添加权限： <uses-permission android:name="android.permission.KILL_BACKGROUND_PROCESSES"/>
 * @author Zhang
 */
    ...
    public static List<ProcessInfo> getProcessInfo(Context context) {
        ...
        for (RunningAppProcessInfo info : runningAppProcesses) {
            ...
            try {
                ...
                //processInfo.icon = context.getResources().getDrawable(R.drawable.icn_setting);
                processInfo.isSystem = true;
                e.printStackTrace();
            }
