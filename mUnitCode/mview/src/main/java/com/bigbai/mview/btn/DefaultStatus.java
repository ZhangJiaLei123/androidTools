...
public class DefaultStatus implements ButtonStatus {
    ...
    public DefaultStatus(CommitButton button, int width, int height) {
        this.button = button;
        this.width = width;
        this.height = height;
        ...
        switch (mEvent.getAction()) {
            ...
            case MotionEvent.ACTION_CANCEL:
                ...
                if(status == Status_Touch){
                    ...
                    //响应监听器
                    CommitButton.OnAnimationButtonClickListener listener = button.getOnAnimationButtonClickListener();
                    if(listener != null){
                        listener.onClick();
                    }
                }
